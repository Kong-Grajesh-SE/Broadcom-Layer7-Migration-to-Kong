...
CONDITIONAL_ASSERTIONS: dict[str, tuple[str, ReviewFlag]] = {
    ...
    "CustomizeErrorResponse": ("response-transformer", ReviewFlag.TRANSFORM_REVIEW),
...
CUSTOM_ASSERTIONS: set[str] = {
    ...
    "CsrfProtection",
    "DocumentStructureThreat",
    "JsonDocumentStructureThreat",
    "ForEachLoop",
    "SchemaValidation",
    "XpathCredential",
    ...
    "Join",
    "MqNativeRouting",
    "ValidateNonSoapSamlToken",
    "CreateSamlToken",
    "SiteMinderCheckProtected",
