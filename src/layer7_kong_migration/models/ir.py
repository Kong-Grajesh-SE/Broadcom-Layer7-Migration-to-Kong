...
ASSERTION_REVIEW_REASONS: dict[str, str] = {
    ...
    "SiteMinderAuthenticate": "CA SSO (SiteMinder) has no direct Kong equivalent - requires OIDC migration",
    ...
    "SqlAttackProtection": "Injection protection rules must be mapped to Kong WAF or pre-function validation",
